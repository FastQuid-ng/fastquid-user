                <div class="offcanvas rounded-sm-4 offcanvas-end overflow-hidden m-sm-4" tabindex="-1" id="cardDetailsOffcanvas" aria-labelledby="cardDetailsOffcanvasLabel">
                    <div class="offcanvas-header rounded-top-4 bg-light">
                        <h5 class="offcanvas-title" id="cardDetailsOffcanvasLabel">Your card details</h5>
                    ...
                    <div class="offcanvas-body d-flex flex-column gap-6">
                        <div class="card border-0 gradient-bottom-right start-purple middle-yellow end-cyan">
                            <div class="position-relative p-6 overlap-10">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col">
                                        <img src="../img/cards/mastercard.svg" class="h-rem-6" alt="...">
                                    </div>
                                    <div class="col-auto">
                                        <span class="badge bg-dark text-success">Active</span>
                                    </div>
                                </div>
                                <div class="mt-8 mb-6">
                                    <span class="surtitle text-dark text-opacity-60">Card number</span>
                                ...
                                <div class="row">
                                    <div class="col"><span class="surtitle text-dark text-opacity-60">Name</span> <span class="d-block h6">John Snow</span></div>
                                    <div class="col"><span class="surtitle text-dark text-opacity-60">Expiry date</span> <span class="d-block h6">11/23</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="hstack gap-6 justify-content-center">
                            <a href="#" class="btn btn-square btn-dark rounded-circle">
                                <span class="svg-icon"><i class="bi bi-eye"></i> </span>
                            </a>
                            <a href="#" class="btn btn-square btn-dark rounded-circle">
                                <span class="svg-icon"><i class="bi bi-snow3"></i></span>
                            </a>
                        </div>
                        <div class="card">
                            <div class="card-body">
                        ...
                        <button type="button" class="btn btn-danger bg-danger-hover w-100 mt-auto">Terminate card</button>
                    </div>
                </div>